...
export default function HeroSection() {
    return (
        <Section className="bg-primary-darkBlue-200 py-32 bg-[url(/assets/bg/curvy-desktop.svg)] bg-no-repeat [background-position:bottom] [background-size:100%_30rem]">
            <WidthRestriction>
                <div className="flex flex-col items-center justify-center gap-8 w-[min(55rem,100%)] mx-auto">
                    ...
                    <div className="text-center grid gap-8">
                        ...
                        <p className="w-[min(40rem,90%)] mx-auto text-xl">
                        ...
                        <Button className="w-[min(25rem,90%)] mx-auto">
                            Get Started
                        </Button>
                    </div>
                </div>
